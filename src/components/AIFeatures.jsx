...
const integrations = [
  ...
  { name: 'WhatsApp', icon: <svg viewBox="0 0 24 24" width="22" height="22"><path d="M12.04 2c-5.46 0-9.91 4.45-9.91 9.91 0 1.75.46 3.45 1.32 4.95L2.05 22l5.25-1.38c1.45.79 3.08 1.21 4.74 1.21 5.46 0 9.91-4.45 9.91-9.91 0-2.65-1.03-5.14-2.9-7.01A9.816 9.816 0 0 0 12.04 2z" fill="#25D366"/></svg> },
  { name: 'HubSpot', icon: <svg viewBox="0 0 24 24" width="22" height="22"><path d="M18.164 7.935V5.556a2.086 2.086 0 1 0-1.637 0v2.379a6.002 6.002 0 0 0-3.642 2.646L6.963 8.35a2.158 2.158 0 1 0-.962 1.325l5.807 2.181a5.977 5.977 0 0 0-.083 1.002c0 .416.046.821.13 1.213l-4.707 3.53a2.164 2.164 0 1 0 1.047 1.261l4.89-3.667a6.008 6.008 0 1 0 5.079-7.259z" fill="#FF7A59"/></svg> },
  { name: 'Stripe', icon: <svg viewBox="0 0 24 24" width="22" height="22"><path d="M13.976 9.15c-2.172-.806-3.356-1.426-3.356-2.409 0-.831.683-1.305 1.901-1.305 2.227 0 4.515.858 6.09 1.631l.89-5.494C18.252.975 15.697.5 12.521.5 6.056.5 1.767 3.96 1.767 9.475c0 6.643 9.151 5.568 9.151 8.784 0 1.134-1.042 1.644-2.457 1.644-2.525 0-5.753-1.196-7.795-2.316l-.932 5.674c2.25 1.144 5.754 1.739 8.727 1.739 6.84 0 11.455-3.385 11.455-9.176 0-7.05-5.94-5.875-5.94-6.674z" fill="#635BFF"/></svg> },
  { name: 'Shopify', icon: <svg viewBox="0 0 24 24" width="22" height="22"><path d="M21.442 5.097c-.146-.432-.524-.707-.945-.722-.421-.016-5.836-.188-5.836-.188s-3.87-3.864-4.238-4.135C9.72-.442 8.75.12 8.75.12S7.48.928 6.825 1.343c-.42.266-.884.288-.884.288s-.863-.642-1.303-.642c-.441 0-.649.336-.739.739L.085 18.917c-.09.403.14.793.535.91 0 0 5.485 1.63 7.828 2.327 2.343.698 3.66.42 3.66.42s5.75-2.226 8.528-3.3c.365-.141.597-.492.57-.882l.236-13.295z" fill="#7AB55C"/></svg> },
]
