    ...
    subProviders: [
        ...
        steps: [
          {
            ...
            description: "Navigate to https://app.workflowmitra.com/credentials and click '+ New credential'.",
            addressUrl: "https://app.workflowmitra.com/credentials",
            hotspot: {
              target: "image",
              top: "21%",
              ...
              popoverTop: "45%",
              popoverLeft: "50%",
              title: "Step 1: Open Credentials Vault",
              detail: "Click '+ New credential' to open the provider selector.",
            },
          },
          {
            image: "/credentials/step2.webp",
            title: "Select WhatsApp -> ChatMitra Provider",
            description: "Select WhatsApp from the provider list and choose 'ChatMitra' from the WhatsApp provider dropdown menu.",
            addressUrl: "https://app.workflowmitra.com/credentials",
            hotspot: {
              target: "image",
              top: "47%",
              ...
              popoverTop: "35%",
              popoverLeft: "65%",
              title: "Step 2: Select ChatMitra Provider",
              detail: "Choose ChatMitra from the WhatsApp provider dropdown list.",
            },
          },
          {
            image: "/credentials/step3.webp",
            title: "Save ChatMitra Credential",
            description: "Enter your Credential Name, API Key, and Instance ID, then click the black 'Save credential' button.",
            addressUrl: "https://app.workflowmitra.com/credentials",
            hotspot: {
              target: "image",
              top: "76%",
              ...
              popoverTop: "35%",
              popoverLeft: "25%",
              title: "Step 3: Save ChatMitra Credentials",
              detail: "Click 'Save credential' to connect ChatMitra.",
            },
          },
        ],
      },
      {
        ...
        steps: [
          {
            image: "/credentials/step1.webp",
            title: "Visit AiSensy Portal & Log In",
            description: "Open https://app.aisensy.com in your web browser and sign in to your AiSensy account.",
            addressUrl: "https://app.aisensy.com",
            hotspot: {
              target: "image",
              top: "4.2%",
              left: "24.5%",
              popoverTop: "38%",
              popoverLeft: "50%",
              title: "Step 1: Open AiSensy Portal",
              detail: "Navigate to app.aisensy.com and log in.",
            },
          },
          {
            image: "/credentials/step2.webp",
            title: "Copy AiSensy API Key",
            description: "Navigate to AiSensy Dashboard -> Manage -> API Key and copy your secret API key.",
            addressUrl: "https://app.aisensy.com/dashboard",
            hotspot: {
              target: "image",
              top: "50%",
              left: "60%",
              ...
              detail: "Click Copy to save your AiSensy API key.",
            },
          },
          {
            image: "/credentials/step3.webp",
            title: "Save AiSensy Credential in Workflow Mitra",
            description: "Return to Workflow Mitra, choose WhatsApp -> AiSensy, paste your API Key, and click 'Save credential'.",
            addressUrl: "https://app.workflowmitra.com/credentials",
            hotspot: {
              target: "image",
              top: "76%",
              ...
              popoverTop: "35%",
              popoverLeft: "25%",
              title: "Step 3: Save AiSensy Credentials",
              detail: "Click 'Save credential' to connect AiSensy.",
            },
          },
        ],
      },
